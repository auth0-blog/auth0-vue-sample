    ...
    <div class="row">
      <div class="col-md-5 mb-4">
        <h6 class="mb-3">
          ...
          >
            <i class="fas fa-link mr-2" />Configure other identity providers
          </a>
        </h6>
        <p>
      ...
      <div class="col-md-5 mb-4">
        <h6 class="mb-3">
          ...
          >
            <i class="fas fa-link mr-2" />Enable Multi-Factor Authentication
          </a>
        </h6>
        <p>
    ...
    <div class="row">
      <div class="col-md-5 mb-4">
        <h6 class="mb-3">
          ...
          >
            <i class="fas fa-link mr-2" />Anomaly Detection
          </a>
        </h6>
        <p>
      ...
      <div class="col-md-5 mb-4">
        <h6 class="mb-3">
          ...
          >
            <i class="fas fa-link mr-2" />Learn About Rules
          </a>
        </h6>
        <p>
